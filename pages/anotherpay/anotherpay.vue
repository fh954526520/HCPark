<template>
	<view class="content">
		...
		<view class="btn">
			<view class="cancle-btn" @click="cancle">
				<button type="default" style="width: 100%;height: 100%; display: flex; align-items: center; justify-content: center;color: #4482FF; background-color:#FFFFFF ;">取消</button>
			</view>
			<view class="confirm-btn" @click="confirm">
				<button type="default" style="width: 100%;height: 100%; display: flex; align-items: center; justify-content: center;background-color: #4482FF; color: #FFFFFF;">确认</button>
			</view>
		</view>
		<view class="tip-information">
			<view style="display: flex;flex-direction: row;align-items: center;justify-content: center;">
				<image src="../../static/image/paydetails/tixing%20(1).png" style="width: 34rpx;height: 34rpx;"></image>
			     <text>温馨提示:&nbsp;&nbsp;&nbsp;要查询欠费的详单请在微信小程序搜索</text>
			</view>
			<view style="display: flex;flex-direction: row;align-items: center;justify-content: center;margin-top: 2vh;">
				<text>“合川智慧停车”点击订单进行查看</text>
			</view>
		</view>
	</view>
</template>
